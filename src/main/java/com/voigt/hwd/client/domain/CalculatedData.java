...
public class CalculatedData {
	...
	public CalculatedData increaseCntSeasons() {
		this.cntSeasons++;
		return this;
	}
	...
	public CalculatedData increaseCntFirstPlace() {
		this.cntFirstPlace++;
		return this;
	}
	...
	public CalculatedData increaseCntSecondPlace() {
		this.cntSecondPlace++;
		return this;
	}
	...
	public CalculatedData increaseCntThirdPlace() {
		this.cntThirdPlace++;
		return this;
	}
	...
	public CalculatedData increaseCntLastPlace() {
		this.cntLastPlace++;
		return this;
	}
	...
	public CalculatedData increaseTotalPoints(float points) {
	...
	public CalculatedData increaseTotalTippPoints(int tippPoints) {
	...
	public CalculatedData increaseCntPlace(int place, int totalUsers) {
		switch (place) {
		case 1:
